...
public class PolygonInfo {
     ...
     */
    public PolygonInfo(final PolygonInfo other) {
     ...
     * @param other     another PolygonInfo to be copied
     */
    public boolean equals(PolygonInfo other) {
//    	if
...
//    ~PolygonInfo();
     ...
     */
    public void setQuad(Quaternion quad) {
     ...
     */
//    public void setTriangles(const TrianglesCommand::Triangles& triangles) {
